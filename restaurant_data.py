...
def favorite_restaurant():
    ...
    #    }
    fave_eatery = input('What is the name of your favorite eatery? ')
    favorite_restaurant['name'] = fave_eatery

    eatery_address = input('What is the address of favorite eatery? ')
    favorite_restaurant['address'] = eatery_address
    
    fave_dish = input('What is your favorite dish? ')
    favorite_restaurant['favorite_dish'] = fave_dish
